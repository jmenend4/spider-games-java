...
public class DificultyReadConverter implements Converter<String, Dificulty> {

	@Override
	public Dificulty convert(String code) {
		Dificulty dificulty = EnumUtils.getDificultyByCode(code);
		if(dificulty == null) {
